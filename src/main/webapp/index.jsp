        ...
        <div class="row">
            <div class="col-12">
                <form class="form-datechoose mt">
                    ...
                    <input class="btn btn-outline-primary mt-3 mb-3" type="submit" value="<fmt:message key="index.find"/>">
                </form>
            </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 shadow-sm h-md-250">
            <div class="card-body d-flex flex-column align-items-start">
              ...
              <p class="card-text mb-auto label">${showtime.begin} ${showtime.getStartTime}</p>
...
<img src="${pageContext.request.contextPath}/images/posters/peppermint-poster1-small.jpg" class="card-img-right flex-auto d-none d-md-block" alt="${showtime.movie.name}" width="110" height="162">
